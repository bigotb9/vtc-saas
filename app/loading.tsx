      ...
      <div className="flex flex-col items-center gap-5">
        <div className="relative">
          <div className="w-20 h-20 rounded-full overflow-hidden animate-pulse">
            <Image src="/logo.png" alt="VTC Platform" width={80} height={80} className="object-cover" priority />
          </div>
        ...
        <div className="flex flex-col items-center gap-1">
          <p className="text-sm font-semibold text-gray-700 dark:text-gray-300">VTC Platform</p>
